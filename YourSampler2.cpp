...
#include "YourSampler2.h"

namespace rl
{
    namespace plan
    {
        YourSampler2::YourSampler2() : Sampler(),
                                     randDistribution(0, 1),
                                     randEngine(::std::random_device()())
        {
        }

        YourSampler2::~YourSampler2()
        {
        }

        ::rl::math::Vector
        YourSampler2::generate()
        {
        ...
        ::std::uniform_real_distribution<::rl::math::Real>::result_type // TODO: test different distributions
        YourSampler2::rand()
        {
        ...
        void
        YourSampler2::seed(const ::std::mt19937::result_type &value)
        {
