#ifndef _YOUR_PLANNER2_H_
#define _YOUR_PLANNER2_H_
 ...
 */
class YourPlanner2 : public RrtConConBase
{
public:
  YourPlanner2(DistributionType distType = DistributionType::NORMAL);

  virtual ~YourPlanner2();
